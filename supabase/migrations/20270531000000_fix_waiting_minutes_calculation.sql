-- ============================================================================
-- Fix Waiting Minutes Calculation in complete_ride_transactional RPC
-- Date: 2027-05-31
-- Description: Trust server-calculated waiting minutes (started_at - driver_arrival_time)
--              as the absolute source of truth instead of client-provided value,
--              preventing the client from overcharging for waiting minutes during a ride.
-- ============================================================================
...
'Atomic ride completion with server-side wait time calculations and financial updates.';
