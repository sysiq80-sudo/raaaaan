...
🔑 قاعدة مهمة: إذا المستخدم ذكر "من" + مكان + "إلى/ل" + مكان آخر، استخرج كلا الموقعين:
- pickup_hint: مكان الانطلاق (بعد "من")
- destination_hint: مكان الوصول (بعد "إلى/لـ")
إذا ذكر مكان واحد فقط بدون "من"، هذا destination_hint فقط.
