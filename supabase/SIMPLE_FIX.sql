-- ===================================
-- السكربت البسيط - خطوة بخطوة
-- ===================================
-- انسخ كل سكشن لوحده وشغله

-- السكشن 1: إنشاء جدول المحافظات
-- ===================================
...
-- السكشن 7: التحقق
-- ===================================
SELECT COUNT(*) as governorates_count FROM governorates;
SELECT COUNT(*) as landmarks_count FROM landmarks;
