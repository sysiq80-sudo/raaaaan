/**
 * ران - مكون معلومات الراكب (مقتطع من ActiveRideCard)
 */
...
interface RiderInfoSectionProps {
    riderInfo: RiderInfo | null;
    rideId: string;
    paymentMethod: string | null;
}

const RiderInfoSection = ({ riderInfo, rideId, paymentMethod }: RiderInfoSectionProps) => {
    ...
    return (
        <div className="flex items-center justify-between mb-4 pb-4 border-b border-border">
            ...
            <div className="flex gap-2">
                {/* Chat Button */}
                <ChatButton rideId={rideId} userType="driver" />
...
export default RiderInfoSection;
