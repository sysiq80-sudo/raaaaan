...
const DriverQuickStats = ({ driverId }: DriverQuickStatsProps) => {
  ...
  if (loading) {
    return (
      <div className="flex flex-col items-start gap-2 shrink-0 pointer-events-auto" dir="ltr">
    ...
    <div className="flex flex-col items-start gap-2 shrink-0 pointer-events-auto" dir="ltr">
      ...
      <AnimatePresence initial={false}>
        {isVisible && (
          ...
          >
            {/* بطاقة الأرباح */}
            <div className="flex items-center gap-2 bg-[#0d1729]/95 backdrop-blur-xl rounded-l-none rounded-r-2xl px-3 py-2.5 border border-l-0 border-[#5bdda6]/20 shadow-[0_4px_20px_rgba(0,0,0,0.45)] w-28" dir="rtl">
            ...
            {/* بطاقة الرحلات */}
            <div className="flex items-center gap-2 bg-[#0d1729]/95 backdrop-blur-xl rounded-l-none rounded-r-2xl px-3 py-2.5 border border-l-0 border-sky-500/20 shadow-[0_4px_20px_rgba(0,0,0,0.45)] w-28" dir="rtl">
