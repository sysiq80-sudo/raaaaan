    ...
    <div className="flex gap-2 overflow-x-auto pb-1 scrollbar-hide">
      {homePlace && (
        <button
          ...
          className="flex items-center gap-2 px-4 py-2.5 rounded-md bg-blue-500/10 hover:bg-blue-500/20 text-blue-600 border border-blue-500/20 transition-all shrink-0 group"
        >
          ...
          <div className="text-right">
            ...
            <p className="text-xs text-blue-500/70 max-w-[120px] truncate">
              {homePlace.address}
            </p>
          </div>
        </button>
      ...
      {workPlace && (
        <button
          ...
          className="flex items-center gap-2 px-4 py-2.5 rounded-md bg-amber-500/10 hover:bg-amber-500/20 text-amber-600 border border-amber-500/20 transition-all shrink-0 group"
        >
          ...
          <div className="text-right">
            ...
            <p className="text-xs text-amber-500/70 max-w-[120px] truncate">
              {workPlace.address}
            </p>
          </div>
        </button>
