...
import { Loader2, Car, MapPin, Clock, X, Users, Search, Star, User, ArrowLeft, Sparkles, Heart, Phone, MessageCircle, Navigation } from "lucide-react";
    ...
    return (
      <div className="fixed inset-0 z-50 bg-gradient-to-b from-background via-green-500/5 to-background overflow-auto">
        <div className="min-h-screen flex flex-col">
          ...
          {/* Live Ride Tracking Bar - Only when driver accepted */}
          <div className="sticky top-[60px] sm:top-[70px] md:top-[80px] z-20 bg-gradient-to-r from-blue-500/95 via-primary/95 to-blue-600/95 backdrop-blur-xl border-b border-white/20 shadow-lg">
            <div className="px-3 py-2 sm:px-4 sm:py-3 md:px-6 md:py-4">
              <div className="flex items-center justify-between gap-2 sm:gap-3 md:gap-4">
                  ...
                  <div className="flex items-center gap-1.5 sm:gap-2">
                    <div className="relative">
                      <div className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 rounded-full bg-white/20 flex items-center justify-center">
                        <Navigation className="w-3 h-3 sm:w-3.5 sm:h-3.5 md:w-4 md:h-4 text-white" />
                      </div>
                      {/* Pulsing indicator */}
                      <div className="absolute -inset-1 rounded-full bg-white/30 animate-ping" />
                    </div>
                    <div className="min-w-0">
                      <p className="text-[10px] sm:text-xs md:text-sm font-bold text-white/90 truncate">
                        السائق في الطريق
                      </p>
                      <p className="text-[9px] sm:text-[10px] md:text-xs text-white/70 truncate">
                        الوصول خلال 5-7 دقائق
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <Button
                  ...
                  size="sm"
                  className="bg-white/20 hover:bg-white/30 text-white border-white/30 hover:border-white/50 backdrop-blur-sm px-2 py-1 sm:px-3 sm:py-1.5 md:px-4 md:py-2 h-auto text-[10px] sm:text-xs md:text-sm font-bold shadow-lg hover:shadow-xl transition-all transform hover:scale-105 active:scale-95"
                >
                  <MapPin className="w-3 h-3 sm:w-3.5 sm:h-3.5 md:w-4 md:h-4 mr-1 sm:mr-1.5 md:mr-2" />
                  <span className="hidden sm:inline">تتبع مباشر</span>
                ...
                <div className="flex items-center gap-1 sm:gap-1.5 md:gap-2">
                  <Button
                    variant="ghost"
                    size="sm"
                    className="w-7 h-7 sm:w-8 sm:h-8 md:w-9 md:h-9 p-0 bg-white/10 hover:bg-white/20 text-white rounded-full"
              ...
              <div className="mt-2 sm:mt-3">
                ...
                <p className="text-[9px] sm:text-[10px] text-white/70 text-center mt-1">
                  2.3 كم • 5 دقائق متبقية
                </p>
              </div>
            </div>
          </div>
