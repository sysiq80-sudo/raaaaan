    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <img src={logo} alt="RAAN" className="w-20 h-20 mx-auto mb-4" />
          <h1 className="text-3xl font-bold text-foreground">ران <span className="text-primary">RAAN</span></h1>
          <p className="text-muted-foreground mt-2">منصة التنقل الذكية</p>
        </div>
        ...
        <Card className="border-0 shadow-xl">
          <CardHeader className="text-center pb-2">
            ...
            <CardDescription>
              ...
              {step === 'register' && "أكمل بياناتك لإنشاء الحساب"}
            </CardDescription>
          </CardHeader>
              ...
              <form onSubmit={handleLogin} className="space-y-4">
                ...
                <div className="bg-muted/50 rounded-lg p-3 flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-medium" dir="ltr">{formatPhoneDisplay(phoneInput)}</span>
                  </div>
                  <Button 
                    type="button"
                    variant="ghost" 
