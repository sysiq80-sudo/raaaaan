...
import { ArrowLeft, Clock, MapPin, Wallet, Users, Star, Navigation, Zap, Route, MapPinned, Shield, HeartHandshake, CreditCard, Smartphone, Facebook, Twitter, Instagram, Phone, Mail } from "lucide-react";
const Index = () => {
  ...
  useEffect(() => {
    ...
    // Redirect to rider page if installed as PWA or on mobile
    ...
    <header className="fixed top-0 left-0 right-0 z-50 glass">
      <div className="container flex items-center justify-between h-16 md:h-20 border-primary">
        ...
        <nav className="hidden lg:flex items-center gap-8">
          <Link to="/" className="text-foreground font-medium">الرئيسية</Link>
          <Link to="#features" className="text-muted-foreground hover:text-primary transition-colors">المميزات</Link>
          <Link to="/driver" className="text-muted-foreground hover:text-primary transition-colors">كن كابتن</Link>
        ...
        <div className="flex items-center gap-3">
          ...
          <Link to="/rider">
            <Button size="sm" className="bg-gradient-primary shadow-glow btn-glow font-semibold px-5">
              احجز الآن
            </Button>
          </Link>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <div className="text-center lg:text-right order-2 lg:order-1">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 mb-6 animate-fade-up opacity-0 fill-forwards">
              ...
              <span className="text-sm font-medium text-primary">الآن في الأنبار</span>
            </div>
            ...
            <div className="relative">
              ...
              <div className="relative w-72 h-[580px] md:w-80 md:h-[640px] bg-card rounded-[3rem] border border-border/50 phone-shadow overflow-hidden">
                ...
                <div className="absolute inset-3 top-10 rounded-[2.5rem] bg-background overflow-hidden border border-border/30">
                  ...
                  <div className="px-5 py-3">
                    ...
                    <p className="text-sm text-muted-foreground">مرحباً، أحمد!</p>
                    <h3 className="text-lg font-bold text-foreground">إلى أين؟</h3>
                  </div>

                  {/* Recent Trips */}
                  <div className="px-5 mt-2">
                    <p className="text-xs font-medium text-muted-foreground mb-3">الرحلات الأخيرة</p>
                    <div className="space-y-2">
                      <div className="flex items-center gap-3 p-3 bg-card rounded-xl border border-border/50 card-hover">
                        ...
                        <div className="flex-1">
                          <p className="text-sm font-medium text-foreground">التأميم - السجارية</p>
                          <p className="text-xs text-muted-foreground">5,500 د.ع</p>
                        </div>
                      </div>
                      <div className="flex items-center gap-3 p-3 bg-card rounded-xl border border-border/50 card-hover">
                        <div className="w-9 h-9 rounded-full bg-primary/10 flex items-center justify-center">
                        ...
                        <div className="flex-1">
                          <p className="text-sm font-medium text-foreground">الملعب - جامعة الأنبار</p>
                          <p className="text-xs text-muted-foreground">4,000 د.ع</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="px-5 mt-4">
                    <p className="text-xs font-medium text-muted-foreground mb-3">نوع السيارة</p>
                    <div className="grid grid-cols-4 gap-2">
                      <div className="text-center p-2 bg-primary/10 rounded-xl border border-primary/30">
                        <span className="text-lg">🚗</span>
                        <p className="text-[10px] text-primary font-medium mt-1">اقتصادي</p>
                      </div>
                      <div className="text-center p-2 bg-card rounded-xl border border-border/50">
                        <span className="text-lg">🚙</span>
                        <p className="text-[10px] text-muted-foreground mt-1">مريح</p>
                      </div>
                      <div className="text-center p-2 bg-card rounded-xl border border-border/50">
                        <span className="text-lg">🚘</span>
                        <p className="text-[10px] text-muted-foreground mt-1">فاخر</p>
                      </div>
                      <div className="text-center p-2 bg-card rounded-xl border border-border/50">
                        <span className="text-lg">👩</span>
                        <p className="text-[10px] text-muted-foreground mt-1">نسائي</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mx-5 mt-4 p-3 bg-gradient-primary rounded-xl">
                    <p className="text-xs font-bold text-primary-foreground">خصم 20% على أول رحلة!</p>
                    <p className="text-[10px] text-primary-foreground/80">استخدم كود: RAAN20</p>
                  </div>
                  ...
                  <div className="absolute bottom-0 left-0 right-0 flex items-center justify-around py-3 bg-card/90 backdrop-blur-lg border-t border-border/30">
                    <div className="flex flex-col items-center gap-0.5">
                      ...
                      <span className="text-[9px] text-primary font-medium">الرئيسية</span>
                    </div>
                    <div className="flex flex-col items-center gap-0.5">
                      <Clock className="w-5 h-5 text-muted-foreground" />
                      <span className="text-[9px] text-muted-foreground">رحلاتي</span>
                    </div>
                    <div className="flex flex-col items-center gap-0.5">
                      <Wallet className="w-5 h-5 text-muted-foreground" />
                      <span className="text-[9px] text-muted-foreground">المحفظة</span>
                    </div>
                    <div className="flex flex-col items-center gap-0.5">
                      <Users className="w-5 h-5 text-muted-foreground" />
                      <span className="text-[9px] text-muted-foreground">حسابي</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="absolute -right-4 top-24 animate-float-slow">
                <div className="bg-card p-3 rounded-2xl shadow-xl border border-border/50 flex items-center gap-3 gradient-border">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">تقييم السائق</p>
                  </div>
                </div>
              </div>
              ...
              <div className="absolute -left-6 bottom-36 animate-float animate-float-delay-1s">
                <div className="bg-card p-3 rounded-2xl shadow-xl border border-border/50 flex items-center gap-3 gradient-border">
                  ...
                  <div>
                    <p className="text-sm font-bold text-foreground">وصل الكابتن</p>
                    <p className="text-xs text-muted-foreground">تويوتا كورولا</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-md mx-auto">
          ...
          <div className="bg-card rounded-3xl border border-border/50 overflow-hidden shadow-2xl gradient-border">
            ...
            <div className="p-6 border-b border-border/30">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-primary font-medium text-sm">4.9 كم</span>
                </div>
              </div>
            </div>
            ...
            <div className="p-6 space-y-4">
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1 p-3 bg-secondary/50 rounded-xl border border-border/30">
                  <p className="text-sm text-foreground font-medium">شارع 20 الرمادي - قرب جامعة الأنبار</p>
                </div>
              </div>
              <div className="flex items-center gap-4">
                <div className="w-3 h-3 rounded-full bg-muted-foreground/50" />
                <div className="flex-1 p-3 bg-secondary/50 rounded-xl border border-border/30">
                  <p className="text-sm text-foreground font-medium">سوق الرمادي المركزي - البوابة الرئيسية</p>
                </div>
              </div>
            </div>
            ...
            <div className="px-6 pb-4">
              <p className="text-xs text-muted-foreground mb-3">اختر نوع السيارة</p>
              <div className="grid grid-cols-4 gap-2">
                <div className="text-center p-3 bg-primary/10 rounded-xl border border-primary/30">
                  <span className="text-xl">🚗</span>
                  <p className="text-xs font-bold text-primary mt-1">اقتصادي</p>
                ...
                <div className="text-center p-3 bg-secondary rounded-xl border border-border/30">
                  <span className="text-xl">🚙</span>
                  <p className="text-xs font-medium text-muted-foreground mt-1">مريح</p>
                  <p className="text-[10px] text-muted-foreground">7,500</p>
                </div>
                <div className="text-center p-3 bg-secondary rounded-xl border border-border/30">
                  <span className="text-xl">👩</span>
                  <p className="text-xs font-medium text-muted-foreground mt-1">نسائي</p>
                  <p className="text-[10px] text-muted-foreground">6,000</p>
                </div>
                <div className="text-center p-3 bg-secondary rounded-xl border border-border/30">
                  <span className="text-xl">🚘</span>
                  <p className="text-xs font-medium text-muted-foreground mt-1">فاخر</p>
            ...
            {/* Payment Method */}
            <div className="px-6 pb-4">
              <p className="text-xs text-muted-foreground mb-3">طريقة الدفع</p>
              <div className="flex gap-2">
                <div className="flex-1 flex items-center justify-center gap-2 p-3 bg-primary/10 rounded-xl border border-primary/30">
                  ...
                  <span className="text-sm font-medium text-primary">نقدي</span>
                </div>
            ...
            <div className="px-6 pb-6">
              <div className="flex items-center gap-4 p-4 bg-secondary/50 rounded-2xl border border-border/30">
                ...
                <div className="flex-1">
                  <p className="font-bold text-foreground">كابتن محمد الدليمي</p>
                  <div className="flex items-center gap-1">
                    <Star className="w-3 h-3 text-primary fill-primary" />
                    <span className="text-xs text-muted-foreground">4.9 • تويوتا كورولا</span>
                  </div>
                </div>
    ...
    <section className="py-20 relative overflow-hidden">
      ...
      <div className="container relative">
        <div className="text-center mb-12">
          <p className="text-muted-foreground mb-2">نطمح لنصل الى ثقة الناس والسوق في ران</p>
          <h3 className="text-4xl md:text-5xl lg:text-6xl font-bold text-primary text-glow">150,000</h3>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <StatCard icon={<Users className="w-6 h-6" />} number="+40" label="كابتن" />
          <StatCard icon={<Star className="w-6 h-6" />} number="85%" label="رضا العملاء" />
      ...
      <div className="container relative">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-muted-foreground text-lg mb-8 leading-relaxed">تبحث عن دخل إضافي، ران توفر لك الفرص الأفضل في الأنبار</p>
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">نسبة عمولة منخفضة وحوافز يومية للسائقين النشطين</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-xl bg-primary/10 flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  <h4 className="font-bold text-foreground mb-1">مرونة كاملة</h4>
                  <p className="text-sm text-muted-foreground">اعمل بوقتك الخاص بدون التزامات أو جداول ثابتة</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-xl bg-primary/10 flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  <h4 className="font-bold text-foreground mb-1">دعم متواصل</h4>
                  <p className="text-sm text-muted-foreground">فريق دعم على مدار الساعة لمساعدتك وحل أي مشكلة</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link to="/driver/register">
                <Button size="lg" className="w-full sm:w-auto bg-gradient-primary shadow-glow btn-glow font-semibold px-8">
                  سجل ككابتن
                  <ArrowLeft className="mr-2 w-5 h-5" />
                </Button>
              </Link>
              ...
              <div className="absolute inset-3 rounded-[2rem] bg-background overflow-hidden">
                <div className="p-5">
                  <div className="flex items-center justify-between mb-6">
                    <div>
                      <p className="text-sm text-muted-foreground">مرحباً كابتن</p>
                      <h3 className="font-bold text-foreground">محمد الدليمي</h3>
                    </div>
                    <div className="w-12 h-12 rounded-full bg-primary/20 flex items-center justify-center text-2xl">
                      👨
                    </div>
        ...
        <div className="grid md:grid-cols-4 gap-10 mb-12">
          <div className="md:col-span-2">
            ...
            <p className="text-muted-foreground max-w-md mb-6 leading-relaxed">
              منصة ران هي الخيار الأمثل للتنقل في الأنبار. نفهم شوارع المحافظة ونوفر لك تجربة تنقل آمنة ومريحة. قريباً في باقي المحافظات!
            </p>
            <div className="flex gap-3">
              <a href="#" title="تابعنا على فيسبوك" className="w-10 h-10 rounded-xl bg-card border border-border/50 hover:bg-primary hover:border-primary transition-all flex items-center justify-center group">
                <Facebook className="w-5 h-5 text-muted-foreground group-hover:text-primary-foreground" />
              </a>
              <a href="#" title="تابعنا على تويتر" className="w-10 h-10 rounded-xl bg-card border border-border/50 hover:bg-primary hover:border-primary transition-all flex items-center justify-center group">
                <Twitter className="w-5 h-5 text-muted-foreground group-hover:text-primary-foreground" />
              </a>
              <a href="#" title="تابعنا على إنستغرام" className="w-10 h-10 rounded-xl bg-card border border-border/50 hover:bg-primary hover:border-primary transition-all flex items-center justify-center group">
          ...
          <div>
            ...
            <ul className="space-y-3 text-muted-foreground">
              ...
              <li><Link to="/driver" className="hover:text-primary transition-colors">كن كابتن</Link></li>
...
const FeatureCard = ({
  ...
  description: string;
  delay: number;
}) => <div className="p-6 bg-card rounded-2xl border border-border/30 hover:border-primary/30 transition-all duration-300 hover:shadow-lg hover:shadow-primary/5 card-hover animate-fade-up opacity-0 fill-forwards" style={{
