...
### الإصدار 1.1.0 (يناير 2026)
- ✅ إصلاح 5 مشاكل حرجة في صفحة الراكب
- ✅ إضافة ملخص الرحلة في لوحة الحجز
- ✅ إضافة Dialog تأكيد الحجز
- ✅ حذف زر وصلت للوجهة من واجهة الراكب
...
| المهمة | الوصف | الحالة |
|--------|-------|--------|
| إشعارات Push للتطبيق | إشعارات فورية للمتصفح والموبايل | ⏳ قيد العمل |
| تفعيل Leaked Password Protection | من إعدادات Supabase Auth | ⏳ يتطلب تفعيل يدوي |
| تحسين أداء الخريطة | تقليل تحديثات DOM | 📋 مخطط |

### أولوية متوسطة 🟡
| المهمة | الوصف | الحالة |
|--------|-------|--------|
| نظام المكافآت والولاء | نقاط لكل رحلة + مستويات | 📋 مخطط |
| دعم اللغة الكردية | ترجمة الواجهة | 📋 مخطط |
| خريطة حرارية للطلب | تحليل مناطق الطلب | 📋 مخطط |

### أولوية منخفضة 🟢
| المهمة | الوصف | الحالة |
|--------|-------|--------|
| Dark/Light mode toggle | تبديل السمة | ✅ موجود جزئياً |
| تصدير البيانات PDF | تقارير للسائقين والإدارة | 📋 مخطط |
